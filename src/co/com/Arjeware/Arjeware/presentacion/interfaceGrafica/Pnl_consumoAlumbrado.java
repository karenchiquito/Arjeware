 ...
 * @author Sebas
 */
public class Pnl_consumoAlumbrado extends JPanel implements ActionListener{
    ...
    public Pnl_consumoAlumbrado (Control_instancias instancias,int width,int height){
        this.width=width;
        this.height=height;
        pp=instancias;
        
        lbl_titulo=new JLabelArje();
            lbl_titulo.setTexto("Consumo manual Alumbrado.", Fonts.microsoftNTL, 1, 14, Colores.color_verdeOscuro);
            this.add(lbl_titulo);
