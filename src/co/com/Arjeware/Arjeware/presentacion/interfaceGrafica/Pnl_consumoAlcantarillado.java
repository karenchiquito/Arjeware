 ...
 * @author Sebas
 */
public class Pnl_consumoAlcantarillado extends JPanel implements ActionListener{
    ...
    private JLabelArje 
        ...
        /*Gasto M3*/
        ,lbl_gastoAlcantarillado,lbl_gastoExceso,lbl_gastoTotal,
        /*EPM*/
    ...
    private JLabelArje
            /*Gasto m3 lb*/
            lb_gastoAlcantarillado,lb_gastoExceso,lb_gastoTotal,
            /*EPM lb*/
    ...
    public Pnl_consumoAlcantarillado(Control_instancias instancias, int width,int height){
        this.width=width;
        this.height=height;
        pp=instancias;
        ...
        lbl_tituloValorConsumos=new JLabelArje();
            lbl_tituloValorConsumos.setTexto("Valor de consumo alcantarillado ($ COP):", Fonts.microsoftNTL, 1, 14, Color.black);
            this.add(lbl_tituloValorConsumos);
            
        lbl_tituloDatos=new JLabelArje();
            lbl_tituloDatos.setTexto("Valores fijos alcantarillado de ("+"EPM"+"): ", Fonts.microsoftNTL, 1, 14, Color.black);
            this.add(lbl_tituloDatos);
            
        lbl_gastoAlcantarillado=new JLabelArje();
            lbl_gastoAlcantarillado.setTexto("Gasto de alcantarillado: ", Fonts.microsoftNTL, 1, 14, Colores.color_verdeClaro,2);
            this.add(lbl_gastoAlcantarillado);
        ...
        /*Gasto m3 lb*/
        lb_gastoAlcantarillado=new JLabelArje();
            lb_gastoAlcantarillado.setTexto("$ 0,0 ", Fonts.microsoftNTL, 1, 14, Colores.color_verdeOscuro);
            this.add(lb_gastoAlcantarillado);
    ...
    lbl_tituloConsumos.setBounds(10+50, 50, 200, 25);
        lbl_gastoAlcantarillado.setBounds(x, y, 125, 25);
        lbl_gastoExceso.setBounds(x, y+30, 125, 25);
        lbl_gastoTotal.setBounds(x, y+30*2, 125, 25);
        
        lb_gastoAlcantarillado.setBounds(x+130, y, 125, 25);
    ...
    lbl_tituloDatos.setBounds(x2+375,50,275,25);
        ...
        lb_valorServicio.setText("$ "+ValorTarifas.getValorServicioAlcantarillado());
                lb_Exceso.setText("$ "+ValorTarifas.getValor_excesoAlcantarillado());
                lb_Subsidio.setText("$ "+Double.parseDouble(ValorTarifas.getSubsidioAlcantarillado())*100+"%");
                lb_valorCargoFijo.setText("$ "+ValorTarifas.getValor_cargoFijoAlcantarillado());
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        unidad,tipoServicio,mes,dia,hora,minuto,segundos,ano,ultimoRegistro,fecha)*/
            ...
            cm.setUnidad("M3");
            cm.setTipoServicio("Alcantarilladoy");
            ...
            lb_gastoAlcantarillado.setText(""+Double.toString(c.getConsumoAgua()));
