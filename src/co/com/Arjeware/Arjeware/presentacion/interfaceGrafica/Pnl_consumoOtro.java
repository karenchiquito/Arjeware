 ...
 * @author Sebas
 */
public class Pnl_consumoOtro extends JPanel implements ActionListener{
    ...
    public Pnl_consumoOtro (Control_instancias instancias,int width,int height){
        this.width=width;
        this.height=height;
        pp=instancias;
        
        lbl_titulo=new JLabelArje();
            lbl_titulo.setTexto("Consumo manual Otros.", Fonts.microsoftNTL, 1, 14, Colores.color_verdeOscuro);
            this.add(lbl_titulo);
