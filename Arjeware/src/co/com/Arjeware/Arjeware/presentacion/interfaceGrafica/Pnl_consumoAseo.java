 ...
 * @author Sebas
 */
public class Pnl_consumoAseo extends JPanel implements ActionListener{
    ...
    public Pnl_consumoAseo (Control_instancias instancias,int width,int height){
        this.width=width;
        this.height=height;
        pp=instancias;
        
        lbl_titulo=new JLabelArje();
            lbl_titulo.setTexto("Consumo manual Aseo.", Fonts.microsoftNTL, 1, 14, Colores.color_verdeOscuro);
            this.add(lbl_titulo);
  ...
  public void paintComponent(Graphics g){
    ...
    iA.setTamano("Btn_aseoFondo", "png", lbl_fondo);
